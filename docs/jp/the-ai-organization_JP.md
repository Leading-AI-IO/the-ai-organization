...
```mermaid
graph TD
    A["Technology — アルゴリズム・モデル<br/>10% ／ ほぼ全ての企業が投資を集中"]
    B["Data — データ基盤・インフラ整備<br/>20% ／ データパイプライン整備"]
    C["People & Organization — 人と組織のリデザイン<br/>70% ／ 評価制度・職種定義・組織構造・リスキリング・カルチャー・インセンティブ<br/>↑<br/>ほぼ全ての企業が放置している最大の価値源泉"]
    A --> B --> C
