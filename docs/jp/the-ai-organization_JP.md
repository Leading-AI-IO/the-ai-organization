...
ITコンサルティング（２つの基幹システムリプレイス含む）、事業開発、デザインシンキング。その交差点で見えたものがある。

**AIの導入が失敗するとき、技術は関係ない。**

失敗するのは、経営層がAIを「技術導入」として扱い、組織設計の問題として捉えないときだ。<br>
AI人材を正当に評価できないときだ。評価制度がAI時代の価値創造と噛み合わないときだ。フィードバックを7ヶ月間与えず、本人が撤退を提案した瞬間に「もっとやるべきだった」と後出しするマネジメントが許容されるときだ。
